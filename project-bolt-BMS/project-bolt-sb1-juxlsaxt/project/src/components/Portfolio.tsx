  ...
  const projects = [
    {
      ...
      description:
        "Pembangunan rumah modern 2 lantai dengan desain minimalis dan material premium.",
    },
    {
      image:
      ...
      category: "Commercial",
      description:
        "Konstruksi gedung perkantoran 8 lantai dengan standar green building.",
    },
    {
      image:
      ...
      category: "Resort",
      description:
        "Pembangunan villa resort dengan konsep eco-friendly dan sustainable design.",
    },
    {
      image:
      ...
      category: "Renovation",
      description:
        "Renovasi total rumah klasik dengan mempertahankan karakter arsitektur asli.",
    },
    {
      image:
      ...
      category: "Housing",
      description:
        "Pembangunan kompleks perumahan 50 unit dengan fasilitas lengkap.",
    },
    {
      image:
      ...
      category: "Residential",
      description:
        "Pembangunan townhouse premium dengan desain kontemporer dan smart home system.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Beberapa proyek terbaik yang telah kami selesaikan dengan standar
            kualitas tinggi.
          </p>
        </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="flex items-center text-[#2e90ff] font-semibold hover:underline">
